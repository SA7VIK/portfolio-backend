...
class RAGSystemSimple:
    def __init__(self, model_name: str = "sentence-transformers/all-MiniLM-L6-v2"):
        """Initialize RAG system with transformers model."""
    ...
    def create_embeddings(self, texts: List[str]) -> np.ndarray:
        """Create embeddings for a list of texts using transformers."""
        # Clean texts
    ...
    def build_index(self, markdown_content: str) -> None:
        """Build similarity index from markdown content."""
        print("Building RAG index (simple mode)...")
    ...
    def retrieve_relevant_chunks(self, query: str, top_k: int = 3) -> List[Tuple[str, float]]:
        ...
        query_embedding = self.create_embeddings([clean_text(query)])
